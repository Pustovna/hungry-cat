export default class Refrigerator {
    ...
    progress() {
        this.totalCount.percentSatiety = Math.round((+this.totalCount.satiety * 100 / this.total));
        this.totalCount.percentMess = Math.round((+this.totalCount.mess * 100 / this.total));
        ...
        if (this.totalCount.percentSatiety > 100) {
            ...
            this.ind1.closest('.stat').children[0].children[1].textContent = this.totalCount.percentSatiety + '%';
        }
        ...
        if (this.totalCount.percentMess > 100){
            ...
            this.ind2.closest('.stat').children[0].children[1].textContent = this.totalCount.percentMess + '%';
        }
    ...
    getText() {
        let modalInfo = [];
        if (this.totalCount.percentSatiety < 50 && this.totalCount.percentMess < 10) {
            modalInfo.push(this.message[1]);
            modalInfo.push(this.message[11]);
        } else if (this.totalCount.percentSatiety < 50 && this.totalCount.percentMess > 10 && this.totalCount.percentMess < 50) {
            modalInfo.push(this.message[2]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety < 50 && this.totalCount.percentMess > 50 && this.totalCount.percentMess < 90) {
            modalInfo.push(this.message[3]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety < 50 && this.totalCount.percentMess > 90) {
            modalInfo.push(this.message[4]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety == 50 && this.totalCount.percentMess == 50) {
            modalInfo.push(this.message[5]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety > 50 && this.totalCount.percentMess > 50 && this.totalCount.percentMess < 90) {
            modalInfo.push(this.message[6]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety > 50 && this.totalCount.percentMess > 90 && this.totalCount.percentSatiety < 100 && this.totalCount.percentMess < 100) {
            modalInfo.push(this.message[7]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety >= 100 && this.totalCount.percentMess >= 100) {
            modalInfo.push(this.message[8]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety > 50 && this.totalCount.percentMess < 50 && this.totalCount.percentMess > 0) {
            modalInfo.push(this.message[9]);
            modalInfo.push(this.message[12]); 
        } else if (this.totalCount.percentSatiety > 50 && this.totalCount.percentMess == 0) {
    ...
    init(foods) {
        const buttons = [document.querySelector('.button--empty'), document.querySelector('.button--full')];
